...
class AnggaranRealisasiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->jenis == "pendapatan") {
            $anggaran_realisasi = AnggaranRealisasi::whereTahun($request->tahun)->whereHas('detail_jenis_anggaran', function ($data) {
                $data->where('jenis_anggaran_id', 1);
            })->latest()->paginate(10);
        } elseif ($request->jenis == "belanja") {
            $anggaran_realisasi = AnggaranRealisasi::whereTahun($request->tahun)->whereHas('detail_jenis_anggaran', function ($data) {
                $data->where('jenis_anggaran_id', 2);
            })->latest()->paginate(10);
        } elseif ($request->jenis == "pembiayaan") {
            $anggaran_realisasi = AnggaranRealisasi::whereTahun($request->tahun)->whereHas('detail_jenis_anggaran', function ($data) {
                $data->where('jenis_anggaran_id', 3);
            })->latest()->paginate(10);
    ...
    private function laporan($request)
    {
        ...
        foreach (AnggaranRealisasi::whereTahun($request->tahun)->whereHas('detail_jenis_anggaran', function ($jenis) {
            $jenis->where('jenis_anggaran_id', 1);
        })->get() as $item) {
        ...
        foreach (AnggaranRealisasi::whereTahun($request->tahun)->whereHas('detail_jenis_anggaran', function ($jenis) {
            $jenis->where('jenis_anggaran_id', 2);
        })->get() as $item) {
        ...
        foreach (AnggaranRealisasi::whereTahun($request->tahun)->whereHas('detail_jenis_anggaran', function ($jenis) {
            $jenis->where('kelompok_jenis_anggaran_id', 31);
        })->get() as $item) {
        ...
        foreach (AnggaranRealisasi::whereTahun($request->tahun)->whereHas('detail_jenis_anggaran', function ($jenis) {
            $jenis->where('kelompok_jenis_anggaran_id', 32);
        })->get() as $item) {
    ...
    public function cart(Request $request)
    {
        ...
        foreach (AnggaranRealisasi::whereTahun($tahun)->whereHas('detail_jenis_anggaran', function ($jenis) {
            $jenis->where('jenis_anggaran_id', 3);
        })->get() as $item) {
    ...
    public function store(Request $request)
    {
        ...
        $jenis = '';
        if ($request->jenis_anggaran == 1) {
            $jenis = 'pendapatan';
        } elseif ($request->jenis_anggaran == 2) {
            $jenis = 'belanja';
        } elseif ($request->jenis_anggaran == 3) {
            $jenis = 'pembiayaan';
        }
