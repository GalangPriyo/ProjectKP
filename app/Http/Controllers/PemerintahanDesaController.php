...
class PemerintahanDesaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pemerintahan-desa.index')->with('success', 'Informasi UMKM/Wirausaha berhasil ditambahkan');
    }
    ...
    public function update(Request $request, PemerintahanDesa $pemerintahan_desa)
    {
        ...
        return back()->with('success', 'Informasi UMKM/Wirausaha berhasil diperbarui');
    }
    ...
    public function destroy(PemerintahanDesa $pemerintahan_desa)
    {
        ...
        return back()->with('success', 'Informasi UMKM/Wirausaha berhasil dihapus');
    }
}
