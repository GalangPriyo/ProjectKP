...
@section('title', 'Website Resmi Pemerintah Desa '. $desa->nama_desa . ' - Event dan Kegiatan')

@section('styles')
<meta name="description" content="Macam-macam event dan kegiatan Desa {{ $desa->nama_desa }}, Kecamatan {{ $desa->nama_kecamatan }}, Kabupaten {{ $desa->nama_kabupaten }}.">
...
@section('header')
<h1 class="text-white text-muted">EVENT DAN KEGIATAN</h1>
