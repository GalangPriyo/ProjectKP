...
<div class="card shadow">
    <div class="card-body">
            ...
            <table class="table table-hover table-sm table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->alamat }}</td>
                        <td>{{ $item->detailDusun ? $item->detailDusun->rt : '-' }}</td>
                        <td>{{ $item->detailDusun ? $item->detailDusun->rw : '-' }}</td>
                    </tr>
                    @empty
                    <tr>
        ...
        {{ $penduduk->links() }}
        <div class="copyright text-center text-xl-left text-muted mt-4">
            File Digital : <a href="https://bit.ly/DatabaseDokumenKependudukan" class="font-weight-bold ml-1" target="_blank">Database Dokumen Kependudukan</a>
        </div>
    </div>
</div>
