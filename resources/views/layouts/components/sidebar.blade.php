<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            ...
            @endif
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(1) == 'kelola-event' || Request::segment(1) == 'tambah-event' || Request::segment(1) == 'event') active @endif" href="{{ route('event.index') }}">
                    <i class="fas fa-calendar text-red"></i>
                    <span class="nav-link-inner--text">Kelola Event dan Kegiatan</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(1) == 'kelola-pemerintahan-desa' || Request::segment(1) == 'tambah-pemerintahan-desa' || Request::segment(1) == 'pemerintahan-desa') active @endif" href="{{ route('pemerintahan-desa.index') }}">
                    ...
                    <span class="nav-link-inner--text">Kelola UMKM dan Wirausaha</span>
                </a>
            </li>
            @if (auth()->user()->level=='admin')
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(1) == 'kelola-peraturandesa' || Request::segment(1) == 'tambah-peraturandesa' || Request::segment(1) == 'peraturandesa') active @endif" href="{{ route('peraturandesa.index') }}">
                    <i class="fas fa-file text-pink"></i>
                    <span class="nav-link-inner--text">Kelola Peraturan Desa</span>
                </a>
            </li>
            @endif
            <li class="nav-item">
