...
@section('title', 'UMKM dan Wirausaha')
                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">UMKM dan Wirausaha</h2>
                                <p class="mb-0 text-sm">Kelola UMKM dan Wirausaha</p>
                            </div>
                            <div class="mb-3">
                                <a href="{{ route('pemerintahan-desa.create') }}" class="btn btn-success" title="Tambah"><i class="fas fa-plus"></i> Tambah UMKM/Wirausaha</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
        <div class="modal-content bg-gradient-danger">
            ...
            <div class="modal-header">
                <h6 class="modal-title" id="modal-title-delete">Hapus UMKM/Wirausaha?</h6>
            ...
            <div class="modal-body">
                ...
                <div class="py-3 text-center">
                    ...
                    <p>Menghapus informasi UMKM/Wirausaha akan menghapus semua data yang dimilikinya</p>
